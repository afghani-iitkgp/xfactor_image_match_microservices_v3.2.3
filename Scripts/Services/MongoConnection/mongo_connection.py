...
class MongoConn:
    def __init__(self, server):
        ...
        self.mongo_atlas_srv = utils.configuration["mongodb_credentials"][server]["mongodb_url"]
        self.client = MongoClient(self.mongo_atlas_srv)
        self.db = self.client[utils.configuration["mongodb_credentials"][server]["database"]]
